...
//Load the file
loader.load(
  `./models/${objToRender}/male-body-scan.glb`,
  function (gltf) {
...
camera.position.z = objToRender === "female-body" ? 25 : 500;
...
const ambientLight = new THREE.AmbientLight(0x333333, objToRender === "female-body" ? 5 : 1);
scene.add(ambientLight);

//This adds controls to the camera, so we can rotate / zoom it with the mouse
if (objToRender === "female-body") {
